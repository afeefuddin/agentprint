...
const items = [
  { href: "/integrations/claude-code", title: "Claude Code activity tracking", description: "Turn historical Claude Code activity into a year-long profile without uploading prompts or source code.", label: "Integration", mark: "/brands/claude.svg", tone: "blue" as const },
  { href: "/integrations/codex", title: "Codex activity tracking", description: "Bring Codex dates, token totals, and model activity into the same durable history.", label: "Integration", mark: "/brands/codex.svg" },
  { href: "/integrations/opencode", title: "OpenCode activity tracking", description: "Add OpenCode usage metadata to your profile while keeping session content on your machine.", label: "Integration", mark: "/brands/opencode.svg" },
  { href: "/integrations/kimi-code", title: "Kimi Code activity tracking", description: "Keep Kimi Code activity visible beside the other coding agents you use.", label: "Integration", mark: "/brands/kimi.svg", tone: "ink" as const },
